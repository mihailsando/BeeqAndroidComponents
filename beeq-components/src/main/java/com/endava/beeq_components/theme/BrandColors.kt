...
object BrandColors {
    ...
    val brand_light: Color
        @Composable get() = colorResource(id = R.color.brand_light)
    val brand_alt: Color
        @Composable get() = colorResource(id = R.color.brand_alt)
    ...
    val accent_light: Color
        @Composable get() = colorResource(id = R.color.accent_light)
    ...
    val data_1: Color
        @Composable get() = colorResource(id = R.color.data_1)
    val data_2: Color
        @Composable get() = colorResource(id = R.color.data_2)
    val data_3: Color
        @Composable get() = colorResource(id = R.color.data_3)
    val data_4: Color
        @Composable get() = colorResource(id = R.color.data_4)
    val data_5: Color
        @Composable get() = colorResource(id = R.color.data_5)
    val data_6: Color
        @Composable get() = colorResource(id = R.color.data_6)
    val data_7: Color
        @Composable get() = colorResource(id = R.color.data_7)
    val data_8: Color
        @Composable get() = colorResource(id = R.color.data_8)
    val data_9: Color
